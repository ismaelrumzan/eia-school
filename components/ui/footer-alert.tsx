  ...
  return (
    <div
      className={`flex justify-center ${
        pathname === "/" ? `bg-[#094931]` : `mb-4`
      }`}>
      <Alert
        color="success"
        className="mb-3 max-w-md"
        icon={Megaphone as FunctionComponent<SVGProps<SVGSVGElement>>}
        additionalContent={<AlertContent />}>
...
function AlertContent(): JSX.Element {
  return (
    <div className="flex flex-col sm:flex-row gap-2">
      ...
      <CTAButton gtmEvent="sign-up-footer" href="/contribute">
        Sign Up Today!
      </CTAButton>
    </div>
  );
